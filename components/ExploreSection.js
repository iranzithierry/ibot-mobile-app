    ...
    return (
        <View className='flex flex-row space-x-2 w-full px-1 pr-3'>
            <View className='flex flex-col space-y-2' style={{ width: '50%', height: hp(40) }}>
                <TouchableOpacity className='shadow-2xl h-full  bg-slate-200 py-2 px-2  rounded-xl ring-1 ring-inset ring-slate-400 flex flex-col items-start justify-between'>
                    ...
                    <View className='flex w-full flex-row items-center justify-between'>
                        <Button borderRadius='rounded-3xl' classNameArg='w-full' size='base' onPress={() => navigation.navigate('ChatScreen')} backgroundColor='rgba(4 120 87 / 1)'>
            ...
            <View className='flex  flex-col space-y-2' style={{ width: '50%', height: hp(40) }}>
                <TouchableOpacity style={{ height: hp(19.5) }} className='shadow-2xl shadow-slate-400 bg-slate-200 py-2 px-2 space-y-4 rounded-xl ring-1 ring-inset ring-slate-400 flex flex-col items-start justify-between'>
                    <View className='flex flex-row justify-start rounded-full bg-white w-fit p-1'>
                        <Icon.ChatBubbleOvalLeftEllipsisIcon size={50} color={'rgba(4 120 87 / 1)'} />
                    </View>
                    <View className='flex w-full flex-row items-center justify-between'>
                        ...
                        <View>
                            <Icon.ArrowRightIcon size={30} color={'rgba(4 120 87 / 1)'} />
                        </View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={{ height: hp(19.5) }} className='shadow-2xl shadow-slate-400 bg-slate-200 py-2 px-2 space-y-4 rounded-xl ring-1 ring-inset ring-slate-400 flex flex-col items-start justify-between'>
                    <View className='flex flex-row justify-start rounded-full bg-white w-fit p-1'>
                        <Icon.GlobeEuropeAfricaIcon size={50} color={'rgba(4 120 87 / 1)'} />
                    </View>
                    <View className='flex w-full flex-row items-center justify-between'>
                        <Text className='break-words font-sans_semibold text-base leading-4 text-slate-900' style={{ maxWidth: 100 }}>
                            Search by image
