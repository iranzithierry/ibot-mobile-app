...
const MessageItem = React.memo(({ item, index, onSelect, onLongPress, visibleTimeIndex, selected }) => {
    const prevItem = index > 0 ? message[index - 1] : null;
    const nextItem = index < message.length - 1 ? message[index + 1] : null;
